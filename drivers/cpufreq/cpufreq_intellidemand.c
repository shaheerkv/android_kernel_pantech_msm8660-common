...
#define MICRO_FREQUENCY_MIN_SAMPLE_RATE		(1500)
#define MIN_FREQUENCY_UP_THRESHOLD		(11)
#define MAX_FREQUENCY_UP_THRESHOLD		(100)
#define MIN_FREQUENCY_DOWN_DIFFERENTIAL		(1)
#define DEFAULT_FREQ_BOOST_TIME			(2500)
#define DEF_SAMPLING_RATE			(5000)
#define BOOSTED_SAMPLING_RATE			(1500)
#define DBS_INPUT_EVENT_MIN_FREQ		(648000)
